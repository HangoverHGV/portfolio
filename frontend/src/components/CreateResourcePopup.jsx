import React, { useState, useEffect } from "react";
    ...
    export default function CreateResourcePopup({
       ...
       const handleSubmit = async (e) => {
            ...
            const newResource = {
                name,
                datetime_started: new Date(datetimeStarted).toISOString(),
                datetime_ended: new Date(datetimeEnded).toISOString(),
            ...
            <div className="modal-overlay">
                <div className="modal">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <label>
                            Start Date and Time:
                            <input type="datetime-local" value={datetimeStarted} onChange={(e) => setDatetimeStarted(e.target.value)} required />
                        </label>
                        <label>
                            End Date and Time:
                            <input type="datetime-local" value={datetimeEnded} onChange={(e) => setDatetimeEnded(e.target.value)} required />
                        </label>
